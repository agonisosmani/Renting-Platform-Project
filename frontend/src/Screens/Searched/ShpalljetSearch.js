...
export default function ShpalljetSearch(props) {
    const [categoryKeyword, setCategoryKeyword] = useState('');
    const [komuna, setKomuna] = useState('');
    const [sortOrder, setSortOrder] = useState('');
    const [submitForm, setSubmitForm] = useState(false);
    const category = props.match.params.category ? props.match.params.category : ''; // tek routes.js e kom url: /category/:category-> pra kom me bo search n baz t kategoris qe kur useri klikon psh n home page te kategorite makina- duhet mem pru n kete page dhe me ja shfaq  ato produkte qe i ka lyp useri me qat kategori e prandaj pe perdori kete logjik kshtu /pra kjo category eshte per url, params.category sepse tek routes e kom /:category -> /category/:category
    ...
    useEffect(() => {
    dispatch(listShpalljet(category));
    ...
    const sortHandler = (e) => {
        ...
        dispatch(listShpalljet(category, komuna, e.target.value));
    };
